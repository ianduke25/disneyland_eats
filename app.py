...
<link href="https://fonts.googleapis.com/css2?family=UnifrakturCook:wght@700&family=Lato:wght@400;600&display=swap" rel="stylesheet">
...
html, body, [data-testid="stAppViewContainer"], [data-testid="stApp"] {
    ...
    animation: gradientMove 100s ease infinite !important;
...
h1, h2, h3 {
    ...
    animation: flicker 8s infinite !important;
}
